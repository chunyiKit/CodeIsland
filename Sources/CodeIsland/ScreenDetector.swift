...
struct ScreenDetector {
    ...
    /// Fixed simulated notch width for non-notch screens.
    /// Keeps external displays visually consistent with the common built-in notch width.
    private static let fakeNotchWidth: CGFloat = 110
